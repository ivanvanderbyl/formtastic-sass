...
<pre>
  @include stack-form(960px,"auto","10px");
</pre>
...
@include form-stack($stacked_fieldset-width, $stacked_input, $stacked_padding, $stacked_button_align, $stacked_select_width);
...
<pre>
  .formtastic
    @include float-form(600px,200px,400px);
</pre>
...
<pre>
  ...
  @include float-inputs(10px);
  @include float-inputs(10px,1.4em);
</pre>
...
<pre>
  @include float-inputs-for("#post_category",10px,1.4em);
  @include float-inputs-for(".required",10px,1.4em);
</pre>
...
<pre>
  @include grid-inputs(100px,1.4em);
</pre>
...
<pre>
  @include grid-inputs-for("#post_category",100px);
  @include grid-inputs-for(".required",100px);
</pre>
...
<pre>
  form.formtastic
    @include formtastic(510px,100px,400px,8px,"right","left");
</pre>
...
<pre>
  form.formtastic
    @include formtastic(100%,20%,70%,4%,"right");
</pre>
...
<pre>
  form.formtastic
    @include formtastic(100%,20%,70%,4%,"right");
    @include formtastic-errors-on-top(21px);
</pre>
